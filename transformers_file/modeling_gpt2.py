...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, input_hidden, attention_score, **kwargs):
        # only last token for inputs_ids if past is defined in kwargs
        if "past" in kwargs and kwargs["past"]:
            input_ids = input_ids[:, -1].unsqueeze(-1)

        inputs = {"input_ids": input_ids, "input_hidden": input_hidden, "attention_score": attention_score}
